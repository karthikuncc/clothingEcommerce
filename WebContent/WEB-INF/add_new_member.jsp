...
.form-style-5 input[type="button"]:hover
{
    ...
    <body>
        ...
        <form:form method="POST" action="/ClothingCloset/admin/addStaff" enctype="multipart/form-data" >
            <fieldset>
                    <legend><span class="number">1</span> Add New Staff Info</legend>
        ...
        <form:password path="password" required="true" placeholder="Password"/>
    			  <form:password path="password" name="conPassword" placeholder="Confirm password *"/>	
